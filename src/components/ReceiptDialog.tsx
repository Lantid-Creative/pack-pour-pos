    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-sm">
        ...
        <div id="receipt-content" className="receipt-font bg-card p-4 rounded-md border border-border">
          ...
          <div className="text-xs text-center mt-2 uppercase">
        ...
        <div className="flex gap-2 mt-2">
          <button
            onClick={onClose}
            className="flex-1 py-2 rounded-md border border-border text-sm font-medium hover:bg-muted transition-colors"
          >
            Close
          </button>
          <button
            onClick={handlePrint}
            className="flex-1 py-2 rounded-md bg-primary text-primary-foreground text-sm font-bold flex items-center justify-center gap-2 hover:opacity-90 transition-colors"
          >
